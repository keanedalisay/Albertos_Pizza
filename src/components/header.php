<header class="header">
    <div class="container container--header">
        <a href="/"><img class="header__logo" src="/assets/images/albertos-pizza-logo.png" alt="The Alberto's Pizza official logo. Redirects to the home page." class="header__logo-image"></a>
        <nav class="header__nav">
            <button class="menu_btn" data-js="menu_btn">
                Menu <img class="menu_btn__icon" data-js="menu_btn_icon" src="/assets/icons/iconmonstr-caret-down-circle-filled.svg" alt="">
            </button>
